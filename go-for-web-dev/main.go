...
func verifyUser(w http.ResponseWriter, r *http.Request, next http.HandlerFunc) { // w is the response and r is the request
  if r.URL.Path == "/login" {
    next(w, r)
    return
  }
...
func main() {
  ...
  mux.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
    ...
    p := Page{Books: []Book{}, Filter: getStringFromSession(r, "Filter"), User: getStringFromSession(r, "User")} // This is a list. The Page is the struct
  ...
  mux.HandleFunc("/books", func (w http.ResponseWriter, r *http.Request) {
    ...
    b := Book{ // This is a list. The Book is the struct. A struct is a user-defined type which combines items of different types into a single type
      PK: -1,
  ...
  mux.HandleFunc("/books/{pk}", func (w http.ResponseWriter, r *http.Request) { // This is the delete book function
...
func find(id string) (ClassifyBookResponse, error) { // This is the find function. It also makes use of the API functions
...
func search(query string) ([]SearchResult, error) { //This search function makes use of the API function to. It is utilized on line 222 of this page
...
func classifyAPI(url string) ([]byte, error) { // This is the API function. It allows this golang application to consume RESTful API endpoints url
